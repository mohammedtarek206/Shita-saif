      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500">
            {language === "ar" ? "انضم إلينا واستمتع بأفضل العروض" : "Join us and enjoy the best offers"}
          </p>
        </div>
        ...
        <div className="glass p-8 rounded-[2.5rem] border-white/20 shadow-2xl">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold ml-2">{language === "ar" ? "كلمة المرور" : "Password"}</label>
              <div className="relative">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-dark px-2 text-gray-500">{language === "ar" ? "أو سجل عبر" : "Or register with"}</span>
            </div>
          </div>
